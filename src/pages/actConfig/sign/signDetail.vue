        ...
        <div class="center-title">
          <div class="center-title-left">
            <div class="center-title-left-item">
              <div class="center-title-left-item-left">微信名:</div>
              <div class="center-title-left-item-right"><el-input v-model="nikename"  placeholder="请输入微信名"></el-input></div>
            </div>
            <div class="center-title-left-item">
...
<script>
  import { signDetailList } from '@/api/request'
  export default{
    data() {
      return {
        msg:['活动设置  /','签到活动 /','签到记录详情'],
        title:'签到记录详情',
        button:['下载当前报表'],
        titPath:'signDetail',
        couponName:'',
    ...
    watch:{
      currentPage:{
          handler(currentPage){
            this.getTabData(this.$route.query.sign_id,this.nikename,this.phone,this.currentPage,this.pageSize)
          },
          deep: true,
          immediate: true,
        },
    ...
    methods:{
      ...
      // 签到纪录详情
      getTabData(sign_id,nikename,phone,currentPage,pageSize){
        this.tabloading = true
        let tsign_id = sign_id;
        let tnikename = nikename;
        let tphone = phone;
        let tcurrentPage = currentPage;
        let tpageSize = pageSize
        signDetailList(tsign_id,tnikename,tphone,tcurrentPage,tpageSize)
          .then(res => {
