      ...
      <div class="centerbody">
        <div class="center-title">
          <div class="center-title-left">
            ...
            <div class="center-title-left-item">
              <div class="center-title-left-item-left">停车场（单选）:</div>
              <div class="center-title-left-item-right">
                <el-select v-model="park_id" placeholder="停用/启用">
                    <el-option
...
<script>
  import { openTheDoorList,childParking } from '@/api/request'
  export default{
    data() {
      return {
        msg:['车场事务管理  /','远程开门 /','远程开门记录'],
        title:'远程开门记录',
        button:['批量导出','远程开门'],
        titPath:'openList',
        options:[],
    ...
    watch:{
      currentPage:{
          handler(currentPage){
            this.getTabData(this.car_number,this.park_id,this.start_date,this.end_date,this.currentPage,this.pageSize)
          },
          deep: true,
          immediate: true,
        },
    ...
    methods:{
      ...
      // 合作泊车企业列表
      getTabData(car_number,park_id,start_date,end_date,currentPage,pageSize){
        ...
        openTheDoorList(tcar_number,tpark_id,tstart_date,tend_date,tcurrentPage,tpageSize)
          .then(res => {
