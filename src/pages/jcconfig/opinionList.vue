          ...
          <div class="center-title-left">
            ...
            <div class="center-title-left-item">
              ...
              <div class="center-title-left-item-right">
                <el-select v-model="park_name" placeholder="请选择">
                    <el-option
...
<script>
  import { opinionList,childParking,opinionDelete } from '@/api/request'
  export default{
    data() {
      return {
        msg:['基础设置 /','意见反馈 /','意见列表'],
    ...
    watch:{
      currentPage:{
          handler(currentPage){
            this.getTabData(this.name,this.phone,this.park_name,this.currentPage,this.pageSize)
          },
          deep: true,
          immediate: true,
        },
    ...
    methods:{
      ...
      // 表格中的意见列表
      getTabData(name,phone,park_name,currentPage,pageSize){
        ...
        opinionList(tname,tphone,tpark_name,tcurrentPage,tpageSize)
          .then(res => {
            if(res.data.code == 200){
