        ...
        <div class="center-title">
          <div class="center-title-left">
            <!-- <div class="center-title-left-item">
              ...
              <div class="center-title-left-item-right"><el-input v-model="zyname" placeholder="请输入"></el-input></div>
            </div> -->
            <!-- <div class="center-title-left-item">
              <div class="center-title-left-item-left">手机号:</div>
              <div class="center-title-left-item-right"><el-input v-model="zyphone" placeholder="请输入"></el-input></div>
            </div> -->
            <div class="center-title-left-item">
              <div class="center-title-left-item-left">角色名:</div>
...
<script>
  import { childJcconfigGroupList,jcconfigGroupList,jcconfigGroupListDelete } from '@/api/request'
  export default{
    data() {
      return {
        msg:['基础设置  /','职员管理    /','职务列表'],
    ...
    watch:{
      currentPage:{
          handler(currentPage){
            this.getTabData(this.group_id,this.currentPage,this.pageSize)
          },
          deep: true,
          immediate: true,
        },
    ...
    methods:{
      ...
      // 表格中的职务列表
      getTabData(group_id,currentPage,pageSize){
        this.tabloading = true
        let zygroup_id = group_id;
        let zycurrentPage = currentPage
        let zypageSize = pageSize

        jcconfigGroupList(zygroup_id,zycurrentPage,zypageSize)
          .then(res => {
            if(res.data.code == 200){
